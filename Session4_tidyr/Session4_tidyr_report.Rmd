---
title: "Session 4: Data Cleaning with tidyverse"
...
# R for Data Science Book and `tidyverse` {.bigger}
...
- <center><img src="./img/data-science-wrangle.png" height="300px" /></center>

# Tidying and manipulating {.bigger}

So far we have been working with clean datasets, but that is far from reality...    
- In most cases, data doesn't come clean (pun intended)...
  <center><img src="./img/IMG_20190428_145506.jpg" height="300px" /></center>  
  
- Most real world data requires cleaning before any modelling or visualization.
...
<center><img src="./img/logos_tidyverse_tidyr_dplyr.png" height="200px" /></center>
...
>- For the details of joining datasets go to [R for Data Science Book: Relational data](https://r4ds.had.co.nz/relational-data.html#join-problems)
...
In this format, it's impossible!      
