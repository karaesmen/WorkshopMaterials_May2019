...
wages <- wages %>%
  mutate(age_cat = cut(age, breaks = seq(0, 100, by=10)))
head(wages, 4)
```

Now I will plot this data and facet it by age categories. `facet_grid` will not be able to facet so many categories nicely. So I will use `facet_wrap` to have a nice and organized plot.
